"""SmartHR360 Core-HR service — base settings.

Employee & organization microservice: profiles, departments, skills,
performance reviews, goals, wellbeing surveys.
...
SPECTACULAR_SETTINGS = {
    "TITLE": "SmartHR360 Core-HR API",
    "DESCRIPTION": (
        "Employee & organization microservice: profiles, departments, "
        "skills, performance reviews, goals and wellbeing surveys."
    ),
    "VERSION": "1.0.0",
